    ...
    public partial class ActualizarPuntoCarga : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                capacidadTxt.Text = pc.CapacidadMaxima + "";
        ...
        protected void ActualizarBtn_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                DateTime vidaUtil = Convert.ToDateTime(vidaUtilTxt.Text);
                //se actualiza puntoCarga con nuevos parametros
                puntoCargaDal.Update(id, tipo, capacidadMaxima, vidaUtil);
